...
# SPIDER_MIDDLEWARES = {
#    'SuperSpider.middlewares.SuperspiderSpiderMiddleware': 543,
# }
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'scrapy.downloadermiddlewares.redirect.RedirectMiddleware': None,  # 禁用默认重定向
    'scrapy.downloadermiddlewares.retry.RetryMiddleware': None  # 禁止默认重试（原封不动发送请求，需求是更换IP再重试）
}
